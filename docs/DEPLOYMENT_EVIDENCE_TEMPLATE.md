...
| 事件复盘 | 演练问题、责任人、截止日期已登记 | `待填写` | `PENDING / E0` | `EV-09` |
...
| UI 验收 | 37/37，FAIL 0，WARN 0 | `E2` | `node scripts/ui-shots.mjs ...`、`node scripts/ui-acceptance.mjs ...` |
